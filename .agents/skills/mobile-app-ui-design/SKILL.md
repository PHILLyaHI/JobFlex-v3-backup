...
Read root `AGENTS.md` and `DESIGN.md` before applying this skill. Their existing tokens, light-only theme, ≤768px viewport switch, and ≥44px touch targets take precedence over generic examples here. Verify JobFlex in a real browser at 390×844; do not introduce a new framework or native-app dependencies for this web project.
