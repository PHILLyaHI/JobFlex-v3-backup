...
Scenes (same timing in every file):
    ...
    4.0–13.2 s  Aerial: zoom in to the house, the pin drops on it, the numbers count in (area, squares, pitch, facets, ridge, hips, valleys)
...
Notes:
  ...
  • The aerial is Bing Maps imagery at zoom 20 (credit shown in the film: 'Imagery © Microsoft'), source/assets/aerial-hq.png; the house is marked with a pin, no outline.
...
Re-rendering (source/):
  ...
  Screens: source/assets/*.png were captured from a local JobFlex with ad-capture*.js (the seeded roof is ad-seed.cjs); the aerial is source/assets/aerial-hq.png (Bing Maps, zoom 20).
