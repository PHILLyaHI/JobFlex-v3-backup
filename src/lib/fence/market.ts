// Regional price calibration for fence estimates — ported 2026-09-18 from
// the owner's FenceScan app (lib/fence/market.ts), tables and all, so both
// apps price a fence in the same market the same way.
//
/**
...
export const BASIS_BY_TYPE: Record<FenceTypeId, MarketBasis> = {
  ...
  "vinyl-privacy": "vinyl",
  "vinyl-picket": "vinyl",
  // Composite boards ship from a handful of national plants — freight only.
  "composite-privacy": "vinyl",
