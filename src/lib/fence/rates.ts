// The contractor's own fence price book — ported 2026-09-18 from the
// owner's FenceScan app (lib/fence/rates.ts). In JobFlex the book is saved
// per organization (FenceCatalog) and mirrored in the browser.
//
/**
