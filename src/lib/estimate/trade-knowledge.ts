...
import { utilityAnchorLines } from "./utility-prices-data";
...
export const TRADES: TradeProfile[] = [
  {
    ...
    anchors: [
      "Tear-off + disposal, one layer: labor $0.50-0.75/sqft (add $0.30-0.45/sqft per extra layer); dumpster $400-700 fixed if separate",
      "Architectural shingles (30-yr, Class A): material $110-160/sq boards; install labor $110-155/sq boards",
      "Synthetic underlayment: material $0.13-0.21/sqft; labor $0.09-0.14/sqft",
      "Ice & water shield: material $0.60-1.10/sqft; labor $0.20-0.35/sqft",
      "Drip edge, aluminum: material $0.75-1.30/linear ft; labor $0.40-0.70/linear ft",
      "Ridge vent: material $3-5/linear ft; labor $1.60-2.70/linear ft",
      "Hip/ridge cap shingles: material $3-5/linear ft; labor $1-1.75/linear ft",
      "Starter strip: material $0.45-0.75/linear ft; labor $0.25-0.40/linear ft",
      "Pipe boot / vent flashing: material $20-45/unit; labor $15-35/unit",
      "Step / wall flashing: material $2-4/linear ft; labor $3-6/linear ft",
      "Decking replacement, 1/2 in OSB or CDX: material $30-46/unit (sheet); labor $30-46/unit",
      "Consumables (nails, sealant, caulk): $100-180 fixed on a 20-30 square roof",
      "Roofing permit + inspection: $150-450 fixed",
      "Final cleanup + magnetic sweep: labor $175-310 fixed",
    ],
    keyQuestions: [
  ...
  },
  {
    ...
    anchors: [
      "Siding removal + disposal: labor $0.45-1.00/sqft",
      "Fiber-cement lap siding: material $2.50-4.00/sqft; labor $3.50-5.50/sqft",
      "Vinyl siding: material $1.20-1.90/sqft; labor $1.50-2.35/sqft",
      "Cedar / wood siding: material $4.00-8.00/sqft; labor $4.00-6.50/sqft",
      "Housewrap: material $0.15-0.30/sqft; labor $0.20-0.40/sqft",
      "Trim / corner boards / casing (fiber-cement or primed): material $1.75-3.75/linear ft; labor $3-4/linear ft",
  ...
  },
  {
    ...
    anchors: [
      "Removal: labor $0.70-1.40/linear ft",
      "5 in seamless aluminum gutter: material $1.75-3.00/linear ft; labor $2.10-3.60/linear ft (6 in: +25%)",
      "Downspout, 2x3 or 3x4 aluminum: material $2.10-3.85/linear ft; labor $2.10-3.85/linear ft",
      "Leaf guard, micro-mesh: material $3.25-7.50/linear ft; labor $3-6/linear ft",
      "Miters / end caps / outlets: material $4-12/unit; labor $4-12/unit",
      "Fascia repair: material $2.75-5.50/linear ft; labor $5-9/linear ft",
    ],
  ...
  },
  {
    ...
    anchors: [
      ...
      "4x4 pressure-treated post set in concrete: material $29-42/unit (post + 2-3 bags concrete); labor $23-35/unit",
      "Single walk gate, 4 ft, with hardware: material $150-300/unit; labor $100-200/unit",
      "Sloped / rocky yard: +18-55% labor",
    ],
  ...
  },
  {
    ...
    anchors: [
      ...
      "Composite decking: material $6-9/sqft; labor $3.25-4.85/sqft",
      "Pressure-treated decking: material $2.30-3.50/sqft; labor $2.30-3.50/sqft",
      "New framing (joists, beams, ledger): material $3.30-5.80/sqft; labor $3.40-6/sqft",
      "Footing + post: material $90-180/unit; labor $120-250/unit",
  ...
  },
  {
    ...
    anchors: [
      "Floor finish removal: labor $1.00-2.25/sqft (tile demo $3-5/sqft)",
  ...
  },
  {
    ...
    anchors: [
      ...
      "Epoxy base coat, 100% solids pigmented (10-12 mil): material $0.65-1.10/sqft; labor $0.45-0.75/sqft",
      "Full flake broadcast to rejection (0.5-0.7 lb/sqft) with scrape and vacuum: material $0.40-0.80/sqft; labor $0.50-0.90/sqft",
      "Polyaspartic clear topcoat (8-10 mil): material $0.90-1.50/sqft; labor $0.45-0.80/sqft (urethane topcoat: material $0.50-0.90/sqft)",
  ...
  },
  {
    ...
    anchors: [
      ...
      "Engineered hardwood: material $5-10/sqft; labor $2.75-4.75/sqft",
      "Solid hardwood, nail-down: material $5.00-8.50/sqft; labor $2.75-4.75/sqft",
      "Laminate: material $1.50-4.00/sqft; labor $2-3/sqft",
      "Carpet + pad: material $2-5/sqft; labor $0.75-1.30/sqft (or $18-45/sq yards)",
      ...
      "Baseboard R&R: labor $2-3/linear ft; new base material $1.50-2.50/linear ft",
    ],
  ...
  },
  {
    ...
    anchors: [
      "Interior walls, 2 coats: material $0.20-0.40/sqft; labor $0.75-1.50/sqft",
      "Ceilings: material $0.15-0.30/sqft; labor $0.65-1.25/sqft",
      "Trim / base / casing: material $0.20-0.40/linear ft; labor $1.00-2.10/linear ft",
      "Doors: material $8-15/unit; labor $50-90/unit",
      "Prep (patch, sand, caulk): material $0.02-0.05/sqft; labor $0.15-0.40/sqft",
      "Exterior siding, 2 coats: material $0.30-0.65/sqft; labor $1.05-2.25/sqft",
  ...
  },
  {
    ...
    anchors: [
      "1/2 in drywall hung: material $0.60-1.00/sqft; labor $0.40-0.70/sqft",
      "Tape + finish level 4: material $0.08-0.16/sqft; labor $0.55-1.20/sqft (level 5 +$0.60)",
  ...
  },
  {
    ...
    preamble:
      "Kitchen remodel proposal. Phases: protection and mobilization (fixed), demolition of cabinets, counters, backsplash and appliances (linear ft) and flooring (sqft), the dumpster (fixed), plumbing rough-in changes (unit per fixture), electrical rough-in — each circuit and device its own line (unit), drywall patch and paint (sqft), base cabinets (linear ft), upper cabinets (linear ft), island (linear ft), countertops fabricated and installed (sqft), backsplash tile (sqft), sink and faucet (unit), the under-sink plumbing (unit), each appliance set and connected (unit), flooring (sqft), trim and finish (linear ft), permit (fixed), final cleanup (fixed). A whole same-layout kitchen runs 24-32 lines; a fixture swap 4-7.",
    phases: [
    ...
    // Reviewed 2025-2026 numbers (docs/remodel-price-audit.md, 2026-09-18).
    anchors: [
      "Kitchen gut to the subfloor: labor $1,800-4,000 for a 12x14 (about $11-24/sqft of kitchen); 20 cu yd dumpster $450-700 fixed, its own line",
      "Stock cabinets: material $100-200/linear ft; semi-custom $200-400; custom $400-800; install labor $50-100/linear ft",
      "Quartz countertop: material $60-120/sqft installed (fabricator); granite $50-100; laminate $25-45",
      "Backsplash tile: material $3-15/sqft (3x6 ceramic subway $3-6); labor $15-25/sqft",
      "Sink: 18-gauge stainless material $250-450/unit, set labor $250-450/unit; pull-down faucet material $250-350/unit",
      "Under-sink plumbing (trap kit, tailpieces, supplies, quarter-turn stops when replaced): material $60-250/unit; labor $150-350/unit",
      "Plumbing rough-in: per fixture in place $600-1,200/unit; per relocated fixture $1,500-3,500/unit",
      "Electrical: new 20 A circuit $450-900/unit; 50 A range circuit $700-1,600/unit; device swap $75-150/unit; new box on an existing circuit $180-400/unit; hardwired under-cabinet LED with driver and dimmer $900-2,000 per 16 linear ft",
      "Appliance set and connect: range $120-250/unit; dishwasher $180-350/unit; hood hung and hardwired $250-500/unit",
      "Paint: material $0.50/sqft; labor $2-3/sqft",
      "Every kitchen job: permit $300-1,500 fixed (King County, Bay Area, NYC $800-2,500); protection $250-600 fixed; final clean $250-500 fixed; drywall patch $250-450 for the first opening; Washington asbestos survey $300-700 fixed",
    ],
    lineRange: "24-32 for a whole kitchen, 4-7 for a fixture swap",
  ...
  },
  {
    ...
    preamble:
      "Bathroom remodel proposal. Phases: protection and mobilization (fixed), gut demolition (fixed) and the dumpster (fixed), plumbing rough-in (unit per fixture), electrical — GFCI circuit, fan, lighting (unit each), framing and blocking (linear ft), cement board (sqft) and waterproofing membrane (sqft), shower pan with curb (unit), floor tile (sqft), wall and shower tile (sqft), vanity and top (unit) with its under-sink plumbing (unit), toilet (unit), tub or shower valve and trim (unit), shower glass (unit), mirror, lighting and accessories (unit), drywall and paint (sqft), exhaust fan ducted outdoors (unit), permit (fixed), cleanup (fixed). A whole hall bath runs 22-30 lines; a fixture swap 4-7.",
    phases: [
      "Protect adjacent areas and mobilize",
    ...
    // Reviewed 2025-2026 numbers (docs/remodel-price-audit.md, 2026-09-18).
    anchors: [
      "Gut to the studs and subfloor, full bath: labor $1,200-2,800 fixed; 10 cu yd dumpster $400-650 fixed (Seattle $550-800), its own line",
      "Plumbing rough-in: per fixture in place $600-1,200/unit; relocated $1,500-3,500/unit; tub-to-shower drain conversion and valve $900-1,800/unit",
      "Electrical: GFCI $120-200/unit; new fan ducted to a roof or wall cap with its switch $1,000-2,200/unit installed (Seattle $1,300-2,600; a replacement on the existing duct $350-700); 20 A GFCI bathroom circuit $450-1,000/unit; vanity light $150-300/unit installed",
      "Cement board: material $2-4/sqft, labor $3-5/sqft; bonded waterproofing membrane: material $2-4/sqft, labor $3-5/sqft — two lines",
      "Shower pan with curb (unit): foam tray system with bonded drain $800-1,200 installed; mud pan $1,200-2,000",
      "Tile: floor material $3-8/sqft, labor $10-18/sqft; shower walls material $3-8/sqft, labor $12-25/sqft; mosaics and niches labor $18-30/sqft",
      "Vanity + top: material $400-1,500/unit; labor $250-450/unit; its under-sink plumbing material $40-150/unit, labor $120-250/unit",
      "Toilet: material $250-550/unit; labor $150-300/unit",
      "Shower valve + trim: material $350-600/unit; labor $400-950/unit",
      "Frameless glass (unit): 60 in. door and panel $1,500-3,000 installed; a single 30 in. door on a 36 in. stall $900-1,600",
      "Paint: labor $2-3/sqft",
      "Every bath job: permit $350-1,200 fixed (Seattle $600-1,500); protection $250-600 fixed; final clean $250-500 fixed; Washington asbestos survey $300-700 fixed",
    ],
    lineRange: "22-30 for a whole bath, 4-7 for a fixture swap",
  ...
  },
  {
    ...
    anchors: [
      ...
      "Excavation + grading: labor $0.80-1.60/sqft",
      "Gravel base: material $35-55/cu yards; labor $0.35-0.70/sqft",
      "Forms: material $1-2/linear ft; labor $2-4/linear ft",
      "Rebar / mesh: material $0.35-0.95/sqft; labor $0.25-0.55/sqft",
      "Concrete 4 in, broom finish: material $160-220/cu yards; labor $1.50-3.00/sqft (stamped $4-7/sqft)",
  ...
  },
  {
    id: "plumbing",
    name: "Plumbing",
    // "sewer" moved to the utilities profile (2026-09-18): a sewer line is
    // civil work; a backed-up sewer is still a plumber's call.
    primary: ["plumbing", "plumber", "water heater", "repipe", "sewer backup", "sewer backed", "sewer clog", "sewer smell", "sewer is backed", "clogged", "backed up", "roots in", "hydro jet", "drain", "faucet", "toilet"],
    ...
    anchors: [
      ...
      "PEX repipe: material $2-4/linear ft; labor $5-9/linear ft",
  ...
  {
    // Owner, 2026-09-18: "run sewer in the street, 300 linear feet … usually
    // around $300,000". Sewer, storm and water lines are civil work priced at
    // public bid prices (lib/estimate/utility-prices-data), never as house
    // plumbing — the plumbing profile's only per-foot anchor was a PEX repipe.
    id: "utilities",
    name: "Underground utilities — sewer, storm and water lines",
    primary: ["sewer", "side sewer", "sewer line", "sewer main", "sewer lateral", "storm drain", "storm sewer", "storm line", "water main", "water service", "culvert", "catch basin", "manhole"],
    keywords: ["trench", "trenching", "lateral", "right-of-way", "sdr", "ductile", "c900", "bypass", "cleanout", "tap", "invert", "bedding", "backfill", "shoring", "restoration"],
    preamble:
      "Underground utility proposal — civil work, never house plumbing. Price at installed public-bid unit prices, taken at contractor cost as the anchors give them: permits and right-of-way use (fixed), mobilization (fixed), traffic control devices and plan (fixed) with flaggers (hour), utility locate and potholing (unit), saw-cut and remove pavement (sq yards), trench excavation with shoring by depth (linear ft), bedding and backfill (cu yards, controlled-density fill under pavement), pipe supplied and laid by diameter and material (linear ft), manholes and cleanouts (unit), the connection or tap to the main (unit), bypass pumping and dewatering (fixed per day), testing — air or water, mandrel, CCTV (linear ft), permanent pavement restoration (sq yards), surface restoration off the street (sqft), as-builts (fixed). A street job runs 14-24 lines; a side sewer in a yard 10-16.",
    phases: [
      "Permits, right-of-way use and the utility's connection permit",
      "Mobilization, the traffic control plan and devices, flaggers",
      "Utility locate and potholing",
      "Saw-cut and remove pavement, or strip sod",
      "Trench excavation with shoring or a trench box, spoils hauled",
      "Dewatering and bypass pumping where needed",
      "Pipe bedding",
      "Pipe supplied and laid on grade",
      "Manholes, cleanouts and structures",
      "Connection to the main or the building drain",
      "Backfill and compaction, controlled-density fill under pavement",
      "Testing: air or water, mandrel, CCTV",
      "Permanent pavement restoration or surface restoration",
      "Cleanup, demobilization and as-builts",
    ],
    anchors: utilityAnchorLines(),
    keyQuestions: ["In the street (right-of-way) or in a yard, and how deep", "Pipe size and material; manholes or cleanouts", "Pavement type and the restoration standard; traffic on the street"],
    lineRange: "14-24 for a street job, 10-16 for a side sewer in a yard",
  },
  {
    id: "hvac",
    name: "HVAC",
    ...
    anchors: [
      "3-ton heat pump system (outdoor + air handler or coil): material $5,000-9,000/unit; labor $900-1,600/unit",
      "Cold-climate or variable-speed 3-ton heat pump: material $7,500-12,000/unit; labor $1,000-1,800/unit",
      "Gas furnace 80k BTU (condensing): material $1,500-2,800/unit; labor $700-1,300/unit",
      "Mini split single zone: material $1,500-3,500/unit; labor $600-1,200/unit",
      "Heat pump water heater 50 gal: material $1,800-3,200/unit; labor $450-900/unit",
      ...
      "Dedicated 240 V circuit with disconnect and whip: material $150-400/unit; labor $300-600/unit",
      "Condensing-furnace PVC venting with condensate drain and neutralizer: material $150-350/unit; labor $250-550/unit",
  ...
  },
  {
    ...
    anchors: [
      ...
      "Fiberglass entry door with frame: material $550-1,400/unit; labor $400-800/unit",
      "Sliding patio door: material $650-1,650/unit; labor $500-900/unit",
      "Casing / trim: material $1.50-3.50/linear ft; labor $3-5/linear ft",
      "Garage door 16x7 insulated: material $800-1,700/unit; labor $200-450/unit",
    ],
  ...
  },
  {
    ...
    anchors: [
      "Blown-in attic to R-38: material $0.80-1.30/sqft; labor $0.40-0.75/sqft",
      ...
      "Air sealing: labor $0.30-0.50/sqft or $400-900 fixed",
      "Removal: labor $0.55-1.25/sqft (wet or contaminated, with sanitizing, $1.00-2.00)",
    ],
  ...
  },
  {
    ...
    anchors: [
      "Paver patio: material $5-10/sqft; labor $5-10/sqft",
      "Retaining wall block: material $11-21/sqft of face; labor $11-21/sqft",
  ...
  },
  {
    ...
    anchors: ["Interior demo: labor $1.50-5/sqft", "Dumpster 20 yd: $450-700 fixed per load", "Hourly labor: $45-75/hour"],
...
export const STATE_COST_INDEX: Record<string, number> = {
  // Recomputed 2026-09-18 with the city index's method at state level (OEWS
  // May 2025 construction wages, Craftsman state material factors); 25 of the
  // old values were off by more than 0.05 (docs/pricing-sources-cities.md).
  // The fallback for a town the city table does not list; rural areas run lower.
  AK: 1.20, AL: 0.87, AR: 0.84, AZ: 0.96, CA: 1.13, CO: 1.01, CT: 1.07, DC: 1.09, DE: 0.98, FL: 0.91, GA: 0.91, HI: 1.24, IA: 0.96,
  ID: 0.94, IL: 1.15, IN: 1.00, KS: 0.94, KY: 0.93, LA: 0.90, MA: 1.15, MD: 1.00, ME: 0.98, MI: 0.99, MN: 1.09, MO: 1.02, MS: 0.86,
  MT: 0.98, NC: 0.91, ND: 1.01, NE: 0.93, NH: 0.99, NJ: 1.14, NM: 0.92, NV: 1.04, NY: 1.10, OH: 1.00, OK: 0.89, OR: 1.10, PA: 1.00,
  RI: 1.05, SC: 0.90, SD: 0.90, TN: 0.92, TX: 0.90, UT: 0.95, VA: 0.95, VT: 0.97, WA: 1.16, WI: 1.04, WV: 0.94, WY: 0.99,
};
