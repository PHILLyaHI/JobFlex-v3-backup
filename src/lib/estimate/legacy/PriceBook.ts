...
export const PRICE_BOOK: PriceBookEntry[] = [
  ...
  },
  {
    ...
    priceHigh: 550,
    priceAvg: 350,
    notes: "Comfort-height 1.28 gpf elongated, material only",
  },
  {
    keywords: ["vanity"],
    category: "PLUMBING",
    ...
    priceHigh: 2200,
    priceAvg: 900,
    notes: "36 in. cabinet $350-900; with top $700-1,100; 60 in. double with top $1,400-2,200; material only",
  },
  {
    keywords: ["lavatory", "bathroom sink", "vanity sink"],
    category: "PLUMBING",
    unit: "EA",
    priceLow: 120,
    priceHigh: 350,
  ...
  },
  {
    ...
    priceHigh: 450,
    priceAvg: 350,
    notes: "18-gauge stainless, material only",
  },
  {
    keywords: ["kitchen faucet", "pull-down faucet"],
    category: "PLUMBING",
    unit: "EA",
    priceLow: 250,
    priceHigh: 350,
  ...
  {
    keywords: ["faucet", "bathroom faucet", "lavatory faucet"],
    category: "PLUMBING",
    unit: "EA",
    priceLow: 120,
    priceHigh: 300,
  ...
  {
    keywords: ["tub", "bathtub", "alcove tub"],
    category: "PLUMBING",
    unit: "EA",
    priceLow: 400,
    priceHigh: 900,
    priceAvg: 650,
    notes: "60 in. alcove, acrylic or steel, material only",
  },
  {
  ...
  },
  {
    ...
    priceHigh: 600,
    priceAvg: 450,
    notes: "Pressure-balance valve body plus trim, material only",
  },
  {
  ...
  },
  {
    ...
    priceHigh: 350,
    priceAvg: 250,
    notes: "1/2-3/4 hp, material only",
  },
  ...
  },
  {
    ...
    priceHigh: 60,
    priceAvg: 45,
    notes: "IC-rated airtight 4 in. LED wafer, material only",
  },
  {
  ...
  },
  {
    ...
    priceHigh: 300,
    priceAvg: 200,
    notes: "80-110 CFM ENERGY STAR, material only; installed and ducted outdoors $1,000-2,200",
  },
  {
  ...
  {
    keywords: ["gfci", "gfci outlet", "gfci receptacle"],
    category: "ELECTRICAL",
    unit: "EA",
    priceLow: 22,
    priceHigh: 35,
    priceAvg: 28,
    notes: "20 A tamper-resistant GFCI, material only",
  },
  {
  ...
  // ==========================================
  {
    ...
    priceHigh: 6,
    priceAvg: 4.5,
    notes: "Standard 12x24 porcelain, material only",
  },
  {
    keywords: ["mosaic tile"],
    category: "TILE_FLOORING",
    unit: "SF",
    priceLow: 8,
    priceHigh: 15,
  ...
  },
  {
    ...
    priceHigh: 45,
    priceAvg: 30,
    notes: "Mid-grade nylon with 8 lb pad, material by the square yard; installed $40-80/SY",
  },
  {
    keywords: ["laminate"],
    category: "TILE_FLOORING",
  ...
  // ==========================================
  {
    ...
    priceHigh: 400,
    priceAvg: 300,
    notes: "Semi-custom standard grade, material only",
  },
  {
  ...
  },
  {
    ...
    priceHigh: 120,
    priceAvg: 85,
    notes: "Quartz $60-120, granite $50-100, the fabricator's installed price",
  },
  {
