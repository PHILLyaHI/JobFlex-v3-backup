...
export const FIXTURES: { id: string; label: string; note?: string; doc: EmailDoc }[] = [
  ...
  {
    id: "b-change-order-itemized",
    label: "8c · buildChangeOrder() — itemized (plywood)",
    note: "Original → approved changes → the lines with tax → new total. `previousTotal` is the contract BEFORE this change.",
    doc: buildChangeOrder({
      org: BRAND,
      clientName: "Jordan Rivera",
      contextTitle: "Roof replacement · 6226 97th Dr NE",
      coTitle: "Plywood replacement",
      description: "rot found on the north slope during tear-off — it has to be replaced before the new roof goes on.",
      amount: 480,
      previousTotal: 14541,
      href: "https://example.com/co/demo-3",
      number: 1,
      lines: [
        { name: "1/2\" CDX plywood · North slope", quantity: 96, unit: "sq ft", unitPrice: 3.75, total: 360 },
        { name: "1/2\" CDX plywood · Around chimney", quantity: 32, unit: "sq ft", unitPrice: 3.75, total: 120 },
      ],
      originalTotal: 14541,
