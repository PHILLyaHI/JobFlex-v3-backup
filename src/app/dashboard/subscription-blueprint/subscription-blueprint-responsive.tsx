...
// Viewport switch for /dashboard/subscription-blueprint — the URL the sidebar's
// Subscription button now points at (owner's call, 2026-08-13).
//
...
export function SubscriptionBlueprintResponsive(props: MobileSubscriptionProps) {
