// Account settings — SUPERSEDED by the Blueprint settings hub (2026-09-03).
//
...
// old-design-pages/dashboard/settings/account/page.tsx and this URL now lands on
// its pane of the hub.
import { redirect } from "next/navigation";

export default function AccountSettingsRedirect() {
  redirect("/dashboard/settings?pane=account");
}
