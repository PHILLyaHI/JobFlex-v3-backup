    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <Card>
          <CardHeader>
            <div>
              <CardTitle>Default markups</CardTitle>
              <CardSubtitle>Applied to every new line-item ladder.</CardSubtitle>
            </div>
            <Badge tone="accent">applies forward</Badge>
          </CardHeader>
          <div className="grid grid-cols-2 gap-3">
            <Input label="Materials markup %" type="number" defaultValue={15} />
            <Input label="Labor markup %" type="number" defaultValue={10} />
            <Input label="Overhead %" type="number" defaultValue={10} />
            <Input label="Profit %" type="number" defaultValue={15} />
          </div>
          <p className="mt-4 text-[11px] text-[color:var(--ink-muted)] leading-relaxed">
            New proposals start with these markups. You can still tune them in the Estimate
            breakdown of any individual proposal.
          </p>
        </Card>
      </div>
