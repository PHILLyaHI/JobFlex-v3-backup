// Integrations settings — SUPERSEDED by the Blueprint settings hub (2026-09-03).
//
...
// old-design-pages/dashboard/settings/integrations/page.tsx and this URL now lands on
// its pane of the hub.
