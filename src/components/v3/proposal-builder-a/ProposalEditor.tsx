...
export function ProposalEditor({
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-8 2xl:grid-cols-5">
        <div className="space-y-6 pb-32 2xl:col-span-3">
        ...
        <div className="2xl:col-span-2">
          {/* Bound the pinned preview to the viewport so a long estimate scrolls
              inside the card instead of clipping its own Total/Scope below the
              fold. The 6rem cap (top-20 = 5rem + a 1rem gap) keeps the bottom
              off the screen edge. */}
          <div className="2xl:sticky 2xl:top-20 2xl:max-h-[calc(100dvh_-_6rem)] 2xl:overflow-y-auto">
