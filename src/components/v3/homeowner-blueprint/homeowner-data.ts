// Homeowner portal — the donor's data block, verbatim.
// Source: `jobflex-homeowner-blueprint (14).html` → "ДАННЫЕ".
//
// The donor writes its strings with \u escapes (× — … ‑ etc.); they are kept
// as the literal characters here since TS source is UTF-8 and the rendered
// output is identical.
