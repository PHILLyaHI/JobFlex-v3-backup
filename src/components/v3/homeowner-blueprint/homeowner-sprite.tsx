// Homeowner portal — the donor's icon sprite, verbatim.
// Source: the hidden `<svg width="0" height="0">` defs block that opens the
// donor's <body>. Every `<use href="#i-…">` on the page resolves against it,
// so it must stay mounted ahead of the markup that references it.
