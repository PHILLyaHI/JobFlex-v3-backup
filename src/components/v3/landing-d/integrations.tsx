  ...
  return (
    <div className="pointer-events-auto absolute inset-y-0 hidden w-[30%] lg:block" style={L ? { left: 0 } : { right: 0 }}>
      ...
      <span className={`${TILE} absolute h-[72px] w-[72px]`} style={L ? { left: "38%", top: "4%" } : { right: "40%", top: "26%" }}>
        {L ? (
          <span className="flex h-full w-full items-center justify-center lp-int-tile bg-[#f22f46]">
      ...
      <span className={`${TILE} absolute h-[84px] w-[84px]`} style={L ? { left: "12%", top: "52%" } : { right: "14%", top: "48%" }}>
        {L ? (
          <span className="flex h-full w-full items-center justify-center lp-int-tile bg-[#0070e0] text-[30px] font-black text-white">P</span>
        ) : (
          <span className="flex h-full w-full items-center justify-center lp-int-tile bg-[#2ca01c] text-[26px] font-black text-white">qb</span>
        )}
      </span>
      {/* calendar / sheets */}
      ...
      <span className={`${TILE} absolute h-[70px] w-[70px]`} style={L ? { left: "30%", top: "76%" } : { right: "2%", top: "80%" }}>
        {L ? (
          <span className="flex h-full w-full items-center justify-center lp-int-tile bg-[#ff4f00]">
