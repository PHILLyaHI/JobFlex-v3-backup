...
stale('written for the fixture-era Settings page (inert Delete, local-only Save). The page is real now: this script renamed the signed-in user and clicked Delete account. Needs a rewrite before it runs again');
