...
Applies to every remodel brief: kitchen, bathroom, whole interior, basement, laundry, office, garage conversion, ADU, and any fixture or appliance replaced inside a house. It sits beside the PROCEDURE block (the ordered steps of a full job) and the brief rules (a stated quantity or price is binding; work not asked for is an option). The procedure says what a full job contains; this method says what a short brief implies, what touching one thing forces, and what is never forgotten.

## 1. HOW TO READ A REMODEL BRIEF
...
## 2. WHAT THE BRIEF IMPLIES

### 2A. KITCHEN — what a kitchen brief implies
...
### 2B. BATHROOM — what a bathroom brief implies
...
### 2C. INTERIOR, BASEMENT, LAUNDRY, OFFICE, GARAGE CONVERSION, ADU — what the brief implies
